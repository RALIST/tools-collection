...
interface TextStats {
  words: number;
  characters: number; // Includes spaces
  charactersNoSpaces: number; // Excludes spaces
  sentences: number;
  paragraphs: number;
  readingTime: number;
}
...
const WordCounter: React.FC = () => {
  ...
  const calculateStats = (text: string): TextStats => {
    ...
    const characters = text.length; // Count with spaces
    const charactersNoSpaces = text.replace(/\s/g, "").length; // Count without spaces
  ...
  return (
    <ToolLayout toolName="wordCounte">
      <div className={styles.wordCounter}>
        <div className={styles.statsGrid}>
          ...
          <div className={styles.statCard}>
            ...
            <div className={styles.statLabel}>Characters (with spaces)</div>
          </div>
          <div className={styles.statCard}>
