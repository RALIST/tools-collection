...
const TextTools: React.FC = () => {
  ...
  return (
    <>
      {" "}
      {/* Use a Fragment instead of the div */}
      <MetaTags
        ...
        structuredData={{
          ...
          description:
            "A comprehensive collection of free online text manipulation and analysis tools including case converter, word counter, and string encoder.",
